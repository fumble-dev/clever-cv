...
const Features = () => {
    ...
    return (
        <div id="features" className="flex flex-col items-center my-10 scroll-mt-12 scroll-smooth">
            ...
            <Title 
                ...
                description={`Our intelligent AI-based resume builder helps you create a professional and personalized resume in minutes — fast, smart, and effortless.`} 
            />
                ...
                >
                    <div className={"flex items-center justify-center gap-6 max-w-md group cursor-pointer"}>
                        <div className={`p-6 group-hover:bg-violet-100 border border-transparent group-hover:border-violet-300  flex gap-4 rounded-xl transition-colors ${!isHover ? 'border-violet-300 bg-violet-100' : ''}`}>
                            ...
                            <div className="space-y-2">
                                <h3 className="text-base font-semibold text-slate-700">Real-Time AI Suggestions</h3>
                                <p className="text-sm text-slate-600 max-w-xs">Get intelligent recommendations for wording, formatting, and structure as you build your resume.</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="flex items-center justify-center gap-6 max-w-md group cursor-pointer">
                        <div className="p-6 group-hover:bg-green-100 border border-transparent group-hover:border-green-300 flex gap-4 rounded-xl transition-colors">
                            ...
                            <div className="space-y-2">
                                <h3 className="text-base font-semibold text-slate-700">Secure Resume Data</h3>
                                <p className="text-sm text-slate-600 max-w-xs">Your personal information and resumes are stored securely with end-to-end encryption and privacy protection.</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="flex items-center justify-center gap-6 max-w-md group cursor-pointer">
                        <div className="p-6 group-hover:bg-orange-100 border border-transparent group-hover:border-orange-300 flex gap-4 rounded-xl transition-colors">
                            ...
                            <div className="space-y-2">
                                ...
                                <p className="text-sm text-slate-600 max-w-xs">Choose from modern, ATS-friendly templates and customize them effortlessly with AI assistance.</p>
                            </div>
                        </div>
                    </div>
                </div>
