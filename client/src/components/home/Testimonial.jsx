...
const Testimonial = () => {
    ...
    const cardsData = [
        {
            ...
            handle: '@riya.codes',
            date: 'April 20, 2025',
            review: 'Creating my resume used to take hours! With this AI resume builder, I made a clean, professional resume in just 10 minutes. Got shortlisted for 3 interviews the same week!'
        },
        {
            ...
            handle: '@arjunmehta',
            date: 'May 10, 2025',
            review: 'Really impressed with how simple it was to use. The AI suggested better ways to describe my projects — very helpful for freshers and tech professionals!'
        },
        {
            ...
            handle: '@snehanair',
            date: 'June 5, 2025',
            review: 'Loved the modern templates and how it automatically formatted everything. Perfect for students applying for placements or internships.'
        },
        {
            ...
            date: 'June 25, 2025',
            review: 'As a designer, I needed a resume that looked unique yet professional. This tool nailed it! The AI customization is a game changer.'
        },
    ];
    ...
    return (
        <div id="testimonials" className="flex flex-col items-center my-10 scroll-mt-12 scroll-smooth">
            ...
            <Title
                title={`What users across India are saying`}
                description={`From students to working professionals — people all over India are using our AI-powered resume builder to create job-ready resumes in minutes.`}
            />
